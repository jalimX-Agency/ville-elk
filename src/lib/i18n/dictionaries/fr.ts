  ...
  tour: {
    ...
    levels: [
      ...
      },
      {
        ...
        name: "Étage",
        title: "Dormir",
        body: "À l'étage, trois suites dont une suite parentale de plus de 50 m², avec des salles de bain en carrelage italien grand format.",
        spaces: ["Suite parentale · plus de 50 m²", "Deux suites", "Carrelage italien grand format", "Jusqu'à 10 invités"],
      },
    ],
  },
  amenities: {
